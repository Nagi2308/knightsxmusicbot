...
from Knightsx.misc import HAPP, SUDOERS, XCB
from Knightsx.utils.database import (get_active_chats,
                                       remove_active_chat,
