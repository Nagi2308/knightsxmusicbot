...
from Knightsx import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from Knightsx.core.call import Knightsx
from Knightsx.utils import seconds_to_min, time_to_seconds
from Knightsx.utils.channelplay import get_channeplayCB
from Knightsx.utils.database import is_video_allowed
from Knightsx.utils.decorators.language import languageCB
from Knightsx.utils.decorators.play import PlayWrapper
from Knightsx.utils.formatters import formats
from Knightsx.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from Knightsx.utils.database import is_served_user
from Knightsx.utils.inline.playlist import botplaylist_markup
from Knightsx.utils.logger import play_logs
from Knightsx.utils.stream.stream import stream
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await Knightsx.stream_call(url)
...
@app.on_callback_query(
    filters.regex("KnightsxPlaylists") & ~BANNED_USERS
)
@languageCB
