...
import config
from Knightsx import Carbon, YouTube, app
from Knightsx.core.call import Knightsx
from Knightsx.misc import db
from Knightsx.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from Knightsx.utils.exceptions import AssistantErr
from Knightsx.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from Knightsx.utils.inline.playlist import close_markup
from Knightsx.utils.pastebin import Knightsxbin
from Knightsx.utils.stream.queue import put_queue, put_queue_index
from Knightsx.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await Knightsx.force_stop_stream(chat_id)
