...
from Knightsx.utils.database import set_cmode
from Knightsx.utils.decorators.admins import AdminActual
...
async def playmode_(client, message: Message, _):
    ...
    if (str(query)).lower() == "disable":
        ...
        return await message.reply_text(
            f"ᴄʜᴀɴɴᴇʟ ᴩʟᴀʏ ᴅɪsᴀʙʟᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ ʙʏ {message.from_user.first_name} ɪɴ {message.chat.title}"
        )
