...
from Knightsx import Telegram, YouTube, app
from Knightsx.misc import SUDOERS, _boot_
from Knightsx.plugins.playlist import del_plist_msg
from Knightsx.plugins.sudoers import sudoers_list
from Knightsx.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from Knightsx.utils.decorators.language import LanguageStart
from Knightsx.utils.formatters import get_readable_time
from Knightsx.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:3] == "sta":
            m = await message.reply_text(
                f"⚜️ ɢᴇᴛᴛɪɴɢ ʏᴏᴜʀ ᴩᴇʀsᴏɴᴀʟ sᴛᴀᴛs ғʀᴏᴍ {config.MUSIC_BOT_NAME} sᴇʀᴠᴇʀ."
            )
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/Knightxbotsupport) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="𝗦𝘂𝗽𝗽𝗼𝗿𝘁", url="https://t.me/Knightxbotsupport"
                        ),
                    ],
                ]
            )
