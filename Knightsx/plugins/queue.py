...
from Knightsx.utils import (Knightsxbin, get_channeplayCB,
                              seconds_to_min)
from Knightsx.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from Knightsx.utils.decorators.language import language, languageCB
from Knightsx.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://files.catbox.moe/wlvqzi.png",
        caption=_["queue_1"],
    )
